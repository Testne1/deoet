...
$useragent = "
              Mozilla/5.0 (Linux; Android 10; SM-J610F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.1.4638.51 Mobile Safari/537.36,
...
echo $lime."\033[1;37m~\033[1;31m[\033[1;32m✓\033[1;31m]$white =>$BGreen  So Luong: $BWhite";
$sl = trim(fgets(STDIN));
...
echo $red."Scan Success Lưu Proxy Tại $BYellow proxieslistscan.txt \n";
